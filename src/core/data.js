...
export const modelComparison = [
  ...
  },
  {
    ...
    color: '#10B981',
    tag: 'Strong',
    description: '200 decision trees (max_depth=8). Strong non-linear fit across all features.',
    params: [
  ...
  {
    model: 'Hybrid Ensemble (RF+XGBoost)',
    r2: 0.88, rmse: 0.488,
    color: '#3B82F6',
    tag: 'Best',
    description: 'Blended RF + XGBoost (60% RF, 40% XGBoost). Highest R² — reaches a perfect 10 under optimal conditions.',
    params: [
      { label: 'RF Weight',  value: '60%' },
      { label: 'XGB Weight', value: '40%' },
      { label: 'Train / Test', value: '520 / 130' },
    ],
    topFeatures: [
